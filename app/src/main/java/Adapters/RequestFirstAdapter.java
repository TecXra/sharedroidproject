...
/**
 * Created by Maimoona on 5/17/2016.
 */

public class RequestFirstAdapter extends BaseAdapter {
    ...
    public RequestFirstAdapter(List<UserSelection> selectUsers, Context context) {
        _data = selectUsers;
        _c = context;
        ...
        v.check.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /* if (radioButton.isChecked()) {
                ...
                prefs.edit().putString("sharingName", data.getName()).commit();
                prefs.edit().putString("sharingPhone", data.getPhone()).commit();
